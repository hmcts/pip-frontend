...
| SSO_SG_SUPER_ADMIN_CTSC            | The ID of SSO security group for CTSC super admin users.                                                                                                                                | No        |
| SSO_SG_SUPER_ADMIN_LOCAL           | The ID of SSO security group for local super admin users.                                                                                                                               | No        |
...
| SESSION_SECRET                     | Unique identifier or value that's used to sign and identify a user's session - can really be any string if you're running locally.                                                      | Yes       |
| SESSION_SECRET_V2                  | As above - enables us to rotate session keys without invalidating user sessions. Can be any string if you're running locally.                                                           | Yes       |
