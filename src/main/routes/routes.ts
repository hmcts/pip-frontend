...
export default function (app: Application): void {
  ...
  function reRenderView(req, res): void {
    return req.url
      ? res.render(
          urlPath(req.url),
          req.i18n.getDataByLanguage(req.lng)[urlPath(req.url)]
        )
  ...
  app.get(
    ...
    app.locals.container.cradle.mediaAccountRequestSubmittedController.get
  );
  app.get(
    "/alphabetical-search",
    app.locals.container.cradle.alphabeticalSearchController.get
  );
  app.post(
    "/alphabetical-search",
    app.locals.container.cradle.alphabeticalSearchController.post
  );
  ...
  app.get(
    "/cookie-policy",
    app.locals.container.cradle.cookiePolicyPageController.get
  );
  app.get(
    "/create-media-account",
    app.locals.container.cradle.createMediaAccountController.get
  );
  app.post(
    "/create-media-account",
    multer({ storage: storage, limits: { fileSize: 2000000 } }).single(
      "file-upload"
    ),
  ...
  app.get(
    "/cancelled-password-reset/:isAdmin",
    app.locals.container.cradle.cancelledPasswordResetController.get
  );
  app.get(
    "/admin-rejected-login",
    app.locals.container.cradle.adminRejectedLoginController.get
  );
  app.get(
    "/media-verification",
    passport.authenticate("media-verification", { failureRedirect: "/" })
  );
  app.get("/login", passport.authenticate("login", { failureRedirect: "/" }));
  app.get(
    "/admin-login",
    passport.authenticate("admin-login", { failureRedirect: "/" })
  );
  app.get(
    "/magistrates-standard-list",
    app.locals.container.cradle.magistratesStandardListController.get
  );
  ...
  app.get(
    "/session-expiring",
    app.locals.container.cradle.sessionExpiringController.get
  );
  app.get(
    "/session-expired",
    app.locals.container.cradle.sessionExpiredController.get
  );
  ...
  app.get(
    "/session-logged-out",
    app.locals.container.cradle.sessionLoggedOutController.get
  );
  ...
  app.post(
    "/view-option",
    app.locals.container.cradle.viewOptionController.post
  );
  app.get(
    "/summary-of-publications",
    app.locals.container.cradle.summaryOfPublicationsController.get
  );
  app.get(
    "/file-publication",
    app.locals.container.cradle.flatFileController.get
  );
  ...
  app.get(
    "/account-home",
    isPermittedMedia,
    app.locals.container.cradle.accountHomeController.get
  );
  app.get(
    "/bulk-unsubscribe",
    isPermittedMedia,
    app.locals.container.cradle.bulkUnsubscribeController.get
  );
  app.post(
    "/bulk-unsubscribe",
    isPermittedMedia,
    app.locals.container.cradle.bulkUnsubscribeController.post
  );
  app.get(
  ...
  app.get(
    "/case-name-search",
    isPermittedMedia,
    app.locals.container.cradle.caseNameSearchController.get
  );
  app.post(
    "/case-name-search",
    isPermittedMedia,
    app.locals.container.cradle.caseNameSearchController.post
  );
  app.get(
  ...
  app.get(
    "/delete-subscription",
    isPermittedMedia,
    app.locals.container.cradle.deleteSubscriptionController.get
  );
  app.get(
  ...
  app.get(
    "/list-download-files",
    isPermittedMedia,
    app.locals.container.cradle.listDownloadFilesController.get
  );
  app.get(
  ...
  app.get(
    ...
    isPermittedMedia,
    app.locals.container.cradle.pendingSubscriptionsController.get
  );
  app.post(
    "/pending-subscriptions",
    isPermittedMedia,
  ...
  app.get(
    "/remove-subscription",
    isPermittedMedia,
    app.locals.container.cradle.pendingSubscriptionsController
      .removeSubscription
  );
  app.get(
    "/subscription-add",
    isPermittedMedia,
    app.locals.container.cradle.subscriptionAddController.get
  );
  app.post(
    "/subscription-add",
    isPermittedMedia,
    app.locals.container.cradle.subscriptionAddController.post
  );
  ...
  app.post(
    ...
    isPermittedMedia,
    app.locals.container.cradle.subscriptionConfigureListConfirmedController
      .post
  );
  app.get(
  ...
  app.get(
    "/admin-dashboard",
    isPermittedAdmin,
    app.locals.container.cradle.adminDashboardController.get
  );
  app.get(
  ...
  app.get(
    "/manual-upload",
    isPermittedManualUpload,
    app.locals.container.cradle.manualUploadController.get
  );
  app.post(
    "/manual-upload",
    isPermittedManualUpload,
  ...
  app.get(
    "/admin-management",
    isPermittedAccountCreation,
    app.locals.container.cradle.adminManagementController.get
  );
  app.post(
    "/admin-management",
    isPermittedAccountCreation,
  ...
  app.get(
    "/manage-user",
    isPermittedAccountCreation,
    app.locals.container.cradle.manageUserController.get
  );
  app.get(
    "/update-user",
    isPermittedAccountCreation,
    app.locals.container.cradle.updateUserController.get
  );
  app.get(
    "/delete-user",
    isPermittedAccountCreation,
    app.locals.container.cradle.deleteUserController.get
  );
  app.post(
  ...
  app.get(
    "/blob-view-locations",
    isPermittedSystemAdmin,
    app.locals.container.cradle.blobViewLocationController.get
  );
  app.get(
  ...
  app.get(
    "/blob-view-json",
    isPermittedSystemAdmin,
    app.locals.container.cradle.blobViewJsonController.get
  );
  app.get(
  ...
  app.get(
    ...
    isPermittedSystemAdmin,
    app.locals.container.cradle.bulkCreateMediaAccountsConfirmationController
      .get
  );
  app.post(
    "/bulk-create-media-accounts-confirmation",
  ...
  app.get(
    ...
    isPermittedSystemAdmin,
    app.locals.container.cradle.manualReferenceDataUploadConfirmationController
      .get
  );
  app.get(
  ...
  app.post(
    "/manage-third-party-users/subscriptions",
    isPermittedSystemAdmin,
    app.locals.container.cradle.manageThirdPartyUsersSubscriptionsController
      .post
  );
  app.get(
    "/user-management",
    isPermittedSystemAdmin,
    app.locals.container.cradle.userManagementController.get
  );
  app.post(
    "/user-management",
    isPermittedSystemAdmin,
  ...
  if (process.env.ENABLE_CFT === "true") {
    ...
    app.get(
      "/cft-rejected-login",
      app.locals.container.cradle.cftRejectedLoginController.get
    );
  }
