...
export default function(app: Application): void {
  ...
  app.get('/remove-list-search', app.locals.container.cradle.removeListSearchController.get);
  app.post('/remove-list-search', app.locals.container.cradle.removeListSearchController.post);
