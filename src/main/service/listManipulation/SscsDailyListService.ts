      ...
      courtList["courtHouse"]["courtRoom"].forEach((courtRoom) => {
        courtRoom["session"].forEach((session) => {
          session["formattedJudiciary"] =
            helperService.getJudiciaryNameSurname(session);
          delete session["judiciary"];

          session["sittings"].forEach((sitting) => {
            sitting["sittingStartFormatted"] =
              helperService.publicationTimeInUkTime(sitting["sittingStart"]);
            ...
            sitting["hearing"].forEach((hearing) => {
              ...
              if (hearing?.informant) {
                hearing["informant"].forEach((informant) => {
                  ...
                  informant["prosecutionAuthorityRef"].forEach(
                    (proscAuthRef) => {
                  ...
                  hearing["prosecutionAuthorityRefFormatted"] =
                    prosecutionAuthorityRefFormatted;
                });
