...
export default class PendingSubscriptionsController {
    public async get(req: PipRequest, res: Response): Promise<void> {
        const pendingSubscriptions = {
            cases: await subscriptionService.getSortedPendingSubscriptions(req.user['userId'], 'cases', pendingCaseSubscriptionSorter),
            courts: await subscriptionService.getSortedPendingSubscriptions(req.user['userId'], 'courts', pendingLocationSubscriptionSorter),
        };
