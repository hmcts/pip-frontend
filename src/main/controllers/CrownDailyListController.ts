...
export default class CrownDailyListController {
  public async get(req: PipRequest, res: Response): Promise<void> {
    ...
    if (searchResults && metaData) {
      ...
      let outputData = civFamMixedService.sculptedCivilFamilyMixedListData(
      ...
      outputData = crimeListsService.findUnallocatedCasesInCrownDailyListData(
        JSON.stringify(outputData)
      );
      ...
      res.render("crown-daily-list", {
        ...cloneDeep(
          req.i18n.getDataByLanguage(pageLanguage)["crown-daily-list"]
        ),
