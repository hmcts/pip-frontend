...
export const HMCTS_ACCESS_URL = process.env.HMCTS_ACCESS_URL || 'https://hmcts-access.aat.platform.hmcts.net';
export const CRIME_IDAM_URL = process.env.CRIME_IDAM_URL || 'https://login.sit.cjscp.org.uk';
