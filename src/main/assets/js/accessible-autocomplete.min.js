                    ...
                    return (
                        e && e.splitText !== undefined && e.parentNode && (!e._component || o)
                            ...
                            : ((i = document.createTextNode(t)),
                              e && (e.parentNode && e.parentNode.replaceChild(i, e), F(e, !0))),
                        (i['__preactattr_'] = !0),
                        i
                    );
                var a = t.nodeName;
                          ...
                          (function S(e, t, n, r, o) {
                              ...
                              if (0 !== m)
                                  for (var g = 0; g < m; g++) {
                                      ...
                                      null != w
                                          ? (d++, (f[w] = _))
                                          : (b || (_.splitText !== undefined ? !o || _.nodeValue.trim() : o)) &&
                                            (p[v++] = _);
                                  }
                              if (0 !== y)
                                  for (var g = 0; g < y; g++) {
                            ...
                            (u = m),
                                ...
                                (m || 1 === t) &&
                                    ...
                                    (b = (function B(t, n, r, o, i, u) {
                                        ...
                                        var a = D(t, n, r, o, u);
                                        return (
                                            i && a.parentNode !== i && i.appendChild(a), --P || ((L = !1), u || T()), a
                                        );
        ...
        function (e, t, n) {
            ...
            i.enhanceSelectElement = function (n) {
                ...
                n.name === undefined && (n.name = ''),
                    n.id === undefined &&
                        (n.selectElement.id === undefined ? (n.id = '') : (n.id = n.selectElement.id)),
                ...
                n(4)(function () {
                    ...
                    ? function (e, t) {
                          for (var n = m(e), r = arguments.length, o = 1, i = d.f, u = h.f; o < r; )
                              for (
                                  var a, s = v(arguments[o++]), l = i ? f(s).concat(i(s)) : f(s), c = l.length, p = 0;
                                  p < c;
        ...
        function (e, t, n) {
            ...
            (t['default'] = o).defaultProps = {
                ...
                tResults: function (e, t) {
                    return (
                        e + ' ' + (1 === e ? 'result' : 'results') + ' ' + (1 === e ? 'is' : 'are') + ' available. ' + t
                    );
                },
            };
        },
