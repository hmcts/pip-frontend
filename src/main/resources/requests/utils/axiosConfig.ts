...
const tenantId = process.env.TENANT_ID
  ...
  : config.get("secrets.pip-ss-kv.TENANT_ID");
const tokenUrl =
...
export const accountManagementApiUrl =
  process.env.ACCOUNT_MANAGEMENT_URL ||
  "https://pip-account-management.staging.platform.hmcts.net";
export const dataManagementApi = axios.create({
  baseURL:
    process.env.DATA_MANAGEMENT_URL ||
    "https://pip-data-management.staging.platform.hmcts.net",
  timeout: 10000,
});
export const subscriptionManagementApi = axios.create({
  baseURL:
    process.env.SUBSCRIPTION_MANAGEMENT_URL ||
    "https://pip-subscription-management.staging.platform.hmcts.net",
  timeout: 10000,
});
...
export const channelManagementApi = axios.create({
  baseURL:
    process.env.CHANNEL_MANAGEMENT_URL ||
    "https://pip-channel-management.staging.platform.hmcts.net",
  timeout: 10000,
});
...
export const getDataManagementCredentials =
  createCredentials(dataManagementUrl);
export const getSubscriptionManagementCredentials = createCredentials(
  subscriptionManagementUrl
);
export const getAccountManagementCredentials =
  createCredentials(accountManagementUrl);
export const getChannelManagementCredentials =
  createCredentials(channelManagementUrl);
