...
describe("Reference Data Manual upload", () => {
  ...
  describe("on POST", () => {
    ...
    test("should redirect to summary page", async () => {
      ...
      sinon
        .stub(FileHandlingService.prototype, "validateFileUpload")
        .returns(null);
      sinon
        .stub(ManualUploadService.prototype, "validateFormFields")
        .resolves(null);
      sinon
      ...
      await request(app)
        ...
        .expect((res) => {
          ...
          expect(res.header["location"]).to.equal(
            "/manual-reference-data-upload-summary?check=true"
          );
        });
    });
  });
