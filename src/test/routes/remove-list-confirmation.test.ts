...
const removePublicationStub = sinon.stub(
...
sinon
  ...
  .resolves({ locationId: "1", name: "Mock Court" });
removePublicationStub
  .withArgs("valid-artefact", "1234-1234-1234-1234")
  .resolves(true);
removePublicationStub
      ...
      await request(app)
        ...
        .expect((res) => {
          ...
          expect(res.header["location"]).to.equal(
            "/remove-list-search-results?locationId=1"
          );
        });
    });
