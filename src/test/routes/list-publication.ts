...
sinon.stub(PublicationService.prototype, 'getIndivPubMetadata').resolves(mockJSON);
sinon.stub(PublicationService.prototype, 'getIndivPubJson').resolves(JSON.parse(mockSJPPublic));
