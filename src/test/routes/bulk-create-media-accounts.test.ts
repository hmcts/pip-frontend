...
validateFileStub.withArgs(file1, 3, ['email', 'firstName', 'surname'], 'en', 'bulk-create-media-accounts').returns(null);
validateFileStub.withArgs(file2, 3, ['email', 'firstName', 'surname'], 'en', 'bulk-create-media-accounts').returns('error');
