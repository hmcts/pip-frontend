...
sinon.stub(DataManipulationService.prototype, 'manipulatedCrownDailyListData').resolves(crownDailyData);
sinon.stub(DataManipulationService.prototype, 'findUnallocatedCasesInCrownDailyListData').resolves(crownDailyData);
