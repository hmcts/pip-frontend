...
sinon.stub(CrownListDataManipulationService.prototype, 'manipulatedCrownDailyListData').resolves(crownDailyData);
sinon.stub(CrownListDataManipulationService.prototype, 'findUnallocatedCasesInCrownDailyListData').resolves(crownDailyData);
