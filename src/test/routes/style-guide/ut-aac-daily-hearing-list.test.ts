...
const rawData = fs.readFileSync(
    path.resolve(__dirname, '../../unit/mocks/utAdministrativeAppealsChamberDailyHearingList.json'),
    'utf-8'
);
...
describe('Upper Tribunal (Administrative Appeals Chamber) Daily Hearing List Page', () => {
    ...
    describe('on GET', () => {
        test('should return Upper Tribunal (Administrative Appeals Chamber) daily hearing list page', async () => {
            await request(app)
                .get('/ut-aac-daily-hearing-list?artefactId=abc')
