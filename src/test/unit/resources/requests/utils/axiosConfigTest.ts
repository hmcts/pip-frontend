...
describe("Testing environment variables", () => {
  ...
  it("Test that tenant ID is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith("secrets.pip-ss-kv.TENANT_ID")
    ).toBeTruthy();
  });
  ...
  it("Test that client id is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith("secrets.pip-ss-kv.CLIENT_ID_INTERNAL")
    ).toBeTruthy();
  });
  ...
  it("Test that client secret is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith("secrets.pip-ss-kv.CLIENT_SECRET_INTERNAL")
    ).toBeTruthy();
  });
  ...
  it("Test that data management url is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith("secrets.pip-ss-kv.DATA_MANAGEMENT_AZ_API")
    ).toBeTruthy();
  });
  ...
  it("Test that subscription management URL is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith(
        "secrets.pip-ss-kv.SUBSCRIPTION_MANAGEMENT_AZ_API"
      )
    ).toBeTruthy();
  });
  ...
  it("Test that account management URL is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith("secrets.pip-ss-kv.ACCOUNT_MANAGEMENT_AZ_API")
    ).toBeTruthy();
  });
  ...
  it("Test that channel management URL is set from environment variable", async () => {
    ...
    expect(
      configSpy.neverCalledWith("secrets.pip-ss-kv.CHANNEL_MANAGEMENT_AZ_API")
    ).toBeTruthy();
  });
