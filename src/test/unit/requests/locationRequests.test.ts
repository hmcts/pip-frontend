...
describe('Location get requests', () => {
  beforeEach(() => {
    ...
    stub
      .withArgs('/locations/filter', { params: { regions: test, jurisdictions: test, language: englishLanguage } })
      .rejects(errorResponse);
    stub
      .withArgs('/locations/filter', { params: { regions: test, jurisdictions: 'error', language: englishLanguage } })
      .rejects(errorMessage);
    stub
      .withArgs('/locations/filter', { params: { regions: test, jurisdictions: 'foo', language: englishLanguage } })
    ...
    stub
      ...
      .resolves({ data: courtList });
    stub
      .withArgs('/locations/filter', { params: { regions: test, jurisdictions: test, language: welshLanguage } })
      .rejects(errorResponse);
    stub
      .withArgs('/locations/filter', { params: { regions: test, jurisdictions: 'error', language: welshLanguage } })
      .rejects(errorMessage);
    stub
      .withArgs('/locations/filter', { params: { regions: test, jurisdictions: 'foo', language: welshLanguage } })
      .rejects(errorRequest);
