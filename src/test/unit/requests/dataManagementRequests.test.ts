...
describe("Data Management requests", () => {
  describe("upload publication", () => {
    ...
    it("should return true on success", async () => {
      ...
      expect(
        await fileUploadAPI.uploadPublication(
          mockUploadFileBody,
          mockUploadFileHeaders
        )
      ).toBe(true);
    });
  ...
  describe("upload json publication", () => {
    ...
    it("should return error response", async () => {
      ...
      sinon
        ...
        .rejects(errorResponse);
      expect(
        await fileUploadAPI.uploadJSONPublication(
          { file: "foo" },
          { headers: {} }
        )
      ).toBe(false);
  ...
  describe("upload reference data", () => {
    ...
    it("should return true on success", async () => {
      ...
      expect(await fileUploadAPI.uploadLocationFile(mockUploadFileBody)).toBe(
        true
      );
    });
    ...
    it("should return error response", async () => {
      sinon
        ...
        .rejects(errorResponse);
      expect(
        await fileUploadAPI.uploadLocationFile({ file: "", fileName: "foo" })
      ).toBe(false);
    });
    ...
    it("should return error request", async () => {
      sinon
        ...
        .rejects(errorRequest);
      expect(
        await fileUploadAPI.uploadLocationFile({ file: "", fileName: "bar" })
      ).toBe(false);
    });
    ...
    it("should return error message", async () => {
      sinon
        ...
        .rejects(errorMessage);
      expect(
        await fileUploadAPI.uploadLocationFile({ file: "", fileName: "baz" })
      ).toBe(false);
    });
  });
});
