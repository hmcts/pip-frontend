...
const manageThirdPartyUsersViewController =
  new ManageThirdPartyUsersViewController();
...
describe("Manage third party users view Controller", () => {
  ...
  const getThirdPartyByUserIdStub = sinon.stub(
  ...
  it("should render third party users page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("manage-third-party-users-view", options);
