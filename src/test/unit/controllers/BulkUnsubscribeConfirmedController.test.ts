...
const bulkDeleteSubscriptionsConfirmedController =
  new BulkUnsubscribeConfirmedController();
  ...
  describe("GET request", () => {
    ...
    it("should render the bulk unsubscribe confirmed page", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs(bulkDeleteConfirmedUrl, i18n[bulkDeleteConfirmedUrl]);

      bulkDeleteSubscriptionsConfirmedController
