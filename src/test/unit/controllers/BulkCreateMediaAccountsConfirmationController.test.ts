...
const bulkCreateMediaAccountsConfirmationController =
  new BulkCreateMediaAccountsConfirmationController();
...
sinon
  .stub(FileHandlingService.prototype, "readCsvToArray")
  .returns(mockAccountsWithHeader);

const createAccountsStub = sinon.stub(
  ...
  describe("GET request", () => {
    ...
    it("should render bulk create media accounts confirmation page", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs(bulkCreateAccountsConfirmationUrl, expectedData);

      bulkCreateMediaAccountsConfirmationController
  ...
  describe("POST request", () => {
    ...
    it("should redirect to bulk create media accounts confirmed page if 'Yes' is selected and success when creating accounts", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs(bulkCreateAccountsConfirmedUrl);
