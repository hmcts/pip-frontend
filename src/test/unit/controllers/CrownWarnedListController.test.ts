...
const crownWarnedListJsonStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationJson"
);
const crownWarnedListMetaDataStub = sinon.stub(
  PublicationService.prototype,
...
sinon
  .stub(CrownWarnedListService.prototype, "manipulateData")
  .returns(listData);
...
describe("Crown Warned List Controller", () => {
  ...
  it("should render the crown warned list page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("crown-warned-list", expectedData);
