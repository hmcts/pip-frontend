...
const deleteCourtReferenceDataConfirmationController =
  new DeleteCourtReferenceDataConfirmationController();
...
describe("Delete Court Reference Data Controller", () => {
  it("should render the court reference data page", () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("delete-court-reference-data-confirmation", expectedData);
  ...
  it("should render confirmation page if unexpected error occurred", () => {
    ...
    const expectedData = {
      ...
      apiError: true,
      errorMessage:
        "Unknown error when attempting to delete the court from reference data",
    };
  ...
  it("should redirect to confirmation page if no option is selected", () => {
    ...
    responseMock
      .expects("redirect")
      .once()
      .withArgs("/delete-court-reference-data-success");
    return deleteCourtReferenceDataConfirmationController
      .post(request, response)
      .then(() => {
        responseMock.verify();
  ...
  it("should render delete court reference data when No is selected", () => {
    ...
    responseMock
      .expects("redirect")
      .once()
      .withArgs("/delete-court-reference-data");
    return deleteCourtReferenceDataConfirmationController
      .post(request, response)
      .then(() => {
        responseMock.verify();
