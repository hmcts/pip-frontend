...
import CreateAdminAccountController from '../../../../main/controllers/admin/CreateAdminAccountController';
...
describe('Create Admin Account Controller', () => {
    ...
    describe('get requests', () => {
        it('should render create admin account page with set cookie', async () => {
            ...
            responseMock.expects('render').once().withArgs('admin/create-admin-account', expectedOptions);
