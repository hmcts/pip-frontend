...
import RemoveListSearchResultsController from '../../../../main/controllers/admin/RemoveListSearchResultsController';
...
describe('Remove List Summary Controller', () => {
    describe('GET request', () => {
        it('should render remove list summary page', async () => {
            ...
            responseMock.expects('render').once().withArgs('admin/remove-list-search-results', expectedOptions);
