...
const subscriptionConfigureListController =
  new SubscriptionConfigureListController();
...
describe("Subscriptions Configure List Controller", () => {
  ...
  it("should render subscription configure list page on get request", () => {
    ...
    return subscriptionConfigureListController
  ...
  it("should redirect to configure list page with correct filters", () => {
    ...
    responseMock
      .expects("redirect")
      .once()
      .withArgs("subscription-configure-list?filterValues=TestValue");

    return subscriptionConfigureListController
      .filterValues(request, response)
      .then(() => {
        responseMock.verify();
      });
  });
