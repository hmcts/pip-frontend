...
const manualReferenceDataUploadSummaryController =
  new ManualReferenceDataUploadSummaryController();
const uploadStub = sinon.stub(
  ManualUploadService.prototype,
  "uploadLocationDataPublication"
);
  ...
  describe("GET view", () => {
    it("should render reference manual data upload summary page", async () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("manual-reference-data-upload-summary", options);
