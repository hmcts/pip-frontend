...
import CreateThirdPartyUserSuccessController from '../../../../main/controllers/system-admin/CreateThirdPartyUserSuccessController';
...
describe('Create third party user success controller', () => {
    it('should render the create third party user success page', async () => {
        ...
        responseMock.expects('render').once().withArgs('system-admin/create-third-party-user-success', expectedOptions);
