...
import CreateSystemAdminAccountController from '../../../../main/controllers/system-admin/CreateSystemAdminAccountController';
...
describe('Create System Admin Account Controller', () => {
    ...
    describe('get requests', () => {
        it('should render create system admin account page with set cookie', async () => {
            ...
            responseMock.expects('render').once().withArgs('system-admin/create-system-admin-account', expectedOptions);
