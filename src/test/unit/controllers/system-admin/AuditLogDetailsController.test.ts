...
import AuditLogDetailsController from '../../../../main/controllers/system-admin/AuditLogDetailsController';
...
describe('Audit log details controller', () => {
    ...
    it('should render the audit log details page', async () => {
        ...
        responseMock.expects('render').once().withArgs('system-admin/audit-log-details', expectedData);
