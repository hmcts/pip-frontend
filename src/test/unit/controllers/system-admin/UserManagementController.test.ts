...
import UserManagementController from '../../../../main/controllers/system-admin/UserManagementController';
...
describe('User management controller', () => {
    ...
    it('should render the user management page', async () => {
        ...
        responseMock.expects('render').once().withArgs('system-admin/user-management', expectedData);
