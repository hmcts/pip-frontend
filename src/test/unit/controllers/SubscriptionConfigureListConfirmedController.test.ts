...
const subscriptionConfigureListConfirmedController =
  new SubscriptionConfigureListConfirmedController();
...
describe("Subscription Configure List Type Confirmed", () => {
  ...
  it("should render the confirmation page", () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("subscription-configure-list-confirmed", expectedData);

    return subscriptionConfigureListConfirmedController
