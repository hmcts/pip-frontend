...
const handleSubStub = sinon.stub(
...
sinon
  .stub(SubscriptionService.prototype, "removeFromCache")
  .withArgs(queryParams, "3")
  .resolves(true);
...
subscriptionStub
  .withArgs(userWithSubscriptions, "courts")
  .resolves([mockCourt]);
  ...
  describe("GET view", () => {
    it("should render the pending subscription page without subscriptions", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("pending-subscriptions", expectedData);
