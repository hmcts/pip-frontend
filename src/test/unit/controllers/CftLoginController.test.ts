...
describe('Cft Login Controller', () => {
  ...
  it('should attempt to redirect to the CFT IDAM', async () => {
    ...
    responseMock.expects('redirect').once().withArgs('https://idam-web-public.aat.platform.hmcts.net?client_id=app-pip-frontend&response_type=code&redirect_uri=' + redirectUri);
