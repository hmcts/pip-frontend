...
const iacDailyListJsonStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationJson"
);
const iacDailyListMetaDataStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationMetadata"
);
sinon
  .stub(IacDailyListService.prototype, "manipulateIacDailyListData")
  .returns(listData);
...
describe("IAC Daily List Controller", () => {
  ...
  it("should render the IAC daily list page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("iac-daily-list", expectedData);
