...
const rawTableData = fs.readFileSync(
  path.resolve(__dirname, "../mocks/etFortnightlyList.json"),
  "utf-8"
);
...
const etDailyListJsonStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationJson"
);
const etDailyListMetaDataStub = sinon.stub(
  PublicationService.prototype,
...
describe("Et Fortnightly List Controller", () => {
  ...
  it("should render the et fortnightly cause list page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("et-fortnightly-list", expectedData);
