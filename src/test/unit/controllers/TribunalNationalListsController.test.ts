...
const rawData = fs.readFileSync(
  path.resolve(__dirname, "../mocks/primaryHealthList.json"),
  "utf-8"
);
...
const primaryHealthListJsonStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationJson"
);
const primaryHealthListMetaDataStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationMetadata"
);
sinon.stub(LocationService.prototype, "getLocationById").resolves(courtData[0]);
sinon
  .stub(TribunalNationalListsService.prototype, "manipulateData")
  .returns(listData);
...
describe("Primary Health List Controller", () => {
  ...
  it("should render the primary health list list page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("primary-health-list", expectedData);
