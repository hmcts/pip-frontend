...
const bulkCreateMediaAccountsController =
  new BulkCreateMediaAccountsController();
...
const validateFileUploadStub = sinon.stub(
  FileHandlingService.prototype,
  "validateFileUpload"
);
const validateFileContentStub = sinon.stub(
  ...
  describe("GET request", () => {
    it("should render the bulk create media accounts page", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs(bulkCreateAccountsUrl, expectedData);
  ...
  describe("POST request", () => {
    it("should redirect to bulk create media accounts confirmation page if no validation error", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs(bulkCreateAccountsConfirmationUrl);
