...
const bulkDeleteSubscriptionsConfirmationController =
  new BulkUnsubscribeConfirmationController();
  ...
  describe("GET request", () => {
    it("should render the bulk unsubscribe confirmation page", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs(bulkDeleteConfirmationUrl, i18n[bulkDeleteConfirmationUrl]);

      bulkDeleteSubscriptionsConfirmationController
  ...
  describe("POST request", () => {
    ...
    it("should redirect to the subscriptions management page if 'No' is selected", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("subscription-management");
    ...
    it("should render the bulk unsubscribe confirmation page with error if no option selected", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs(bulkDeleteConfirmationUrl, expectedData);
