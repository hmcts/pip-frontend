...
sinon.stub(DataManipulationService.prototype, 'manipulatedCrownDailyListData').returns(listData);
sinon.stub(DataManipulationService.prototype, 'findUnallocatedCasesInCrownDailyListData').returns(listData);
