...
sinon
  .stub(FilterService.prototype, "handleFilterInitialisation")
  .resolves({ alphabetisedList: {}, filterOptions: {} });
  ...
  describe("get", () => {
    it("should render the alphabetical search page", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("alphabetical-search", expectedData);
  ...
  describe("post", () => {
    ...
    it("should render page with body", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("alphabetical-search?filterValues=Manchester");
    ...
    it("should render page after switching Region for Location", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("alphabetical-search?filterValues=Crown");
  ...
  describe("GET requests", () => {
    ...
    it("should render court name search page", () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("location-name-search", expectedData);
  ...
  describe("POST requests", () => {
    ...
    it("should render court name search page if filters are applied", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("location-name-search?filterValues=");
    ...
    it("should render court name search page if more than 2 filters are applied", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("location-name-search?filterValues=crown,london");
    ...
    it("should render court name search page if only jurisdiction filter is applied", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("location-name-search?filterValues=crown");
    ...
    it("should render court name search page if only region filter is applied", () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("location-name-search?filterValues=london");
