...
const invalidMockData = {'firstName': 'INVALID_DATA', userRoleObject: {mapping: 'SYSTEM_ADMIN'}};
createAccountStub.withArgs(invalidMockData, validUserId).resolves({error: 'General Error', duplicate: false, aboveMaxSystemAdmin: false});

const invalidMockDataDuplicate = {'firstName': 'IS_DUPLICATE_DATA', userRoleObject: {mapping: 'SYSTEM_ADMIN'}};
createAccountStub.withArgs(invalidMockDataDuplicate, validUserId).resolves({error: '', duplicate: true, aboveMaxSystemAdmin: false});

const invalidMockDataMaxUsers = {'firstName': 'IS_MAX_USERS_DATA', userRoleObject: {mapping: 'SYSTEM_ADMIN'}};
createAccountStub.withArgs(invalidMockDataMaxUsers, validUserId).resolves({error: '', duplicate: false, aboveMaxSystemAdmin: true});
