...
const createSystemAdminAccountSummaryController =
  new CreateSystemAdminAccountSummaryController();
  ...
  describe("on get", () => {
    it("should render create system admin account summary page", async () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("create-system-admin-account-summary", expectedOptions);
  ...
  describe("on post", () => {
    it("should render create system admin account confirm page with success message", async () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("create-system-admin-account-confirm", expectedOptions);
