...
const mediaAccountApplicationByIdOnlyStub = sinon.stub(
  MediaAccountApplicationService.prototype,
  "getApplicationById"
);
const mediaAccountApplicationImageStub = sinon.stub(
  MediaAccountApplicationService.prototype,
  "getImageById"
);
...
describe("Media Account Review Controller Test", () => {
  ...
  it("should render media account review page when applicant id provided", async () => {
    ...
    mediaAccountApplicationStub
      .withArgs(applicantId, status)
    ...
    responseMock
      ...
      .withArgs("media-account-review", {
        ...cloneDeep(
          request.i18n.getDataByLanguage(request.lng)["media-account-review"]
        ),
  ...
  it("should render media account review page when image type is in all caps", async () => {
    ...
    mediaAccountApplicationStub
      .withArgs(applicantId, status)
      .resolves(dummyApplicationAllCapsFileType);
  ...
  it("should render media account review page when image type is in mixed caps", async () => {
    ...
    mediaAccountApplicationStub
      .withArgs(applicantId, status)
      .resolves(dummyApplicationMixedCapsFileType);
  ...
  it("should render image when applicant id and image id provided", async () => {
    ...
    mediaAccountApplicationByIdOnlyStub
    ...
    responseMock
      .expects("set")
      .once()
      .withArgs("Content-Disposition", "inline;filename=ImageName.jpg");
  ...
  it("should render error when image is not one of the expected types", async () => {
    ...
    mediaAccountApplicationByIdOnlyStub
      .withArgs(applicantId)
      .resolves(dummyApplicationWithUnknownImageType);
    mediaAccountApplicationImageStub.withArgs(imageId).resolves(dummyImage);
