...
const copDailyCauseListJsonStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationJson"
);
const copDailyCauseListMetaDataStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationMetadata"
);
sinon.stub(LocationService.prototype, "getLocationById").resolves(courtData[0]);
sinon
  .stub(CopDailyListService.prototype, "manipulateCopDailyCauseList")
  .returns(listData);
sinon
  .stub(ListParseHelperService.prototype, "getRegionalJohFromLocationDetails")
  .returns("Test JoH");
...
describe("Cop Daily Cause List Controller", () => {
  ...
  it("should render the cop daily cause list page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("cop-daily-cause-list", expectedData);
