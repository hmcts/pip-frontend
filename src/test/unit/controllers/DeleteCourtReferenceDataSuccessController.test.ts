...
const deleteCourtReferenceDataSuccessController =
  new DeleteCourtReferenceDataSuccessController();
...
describe("Delete Court Reference Data Controller", () => {
  it("should render the court reference data list page", () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("delete-court-reference-data-success", expectedData);
    return deleteCourtReferenceDataSuccessController
