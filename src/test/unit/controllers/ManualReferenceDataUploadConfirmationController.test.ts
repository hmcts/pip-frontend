...
import ManualReferenceDataUploadConfirmationController
  from '../../../main/controllers/ManualReferenceDataUploadConfirmationController';
...
describe('Reference data file upload Confirmation Controller', () => {
  it('should render confirmation page', async () => {
    ...
    responseMock.expects('render').once().withArgs('manual-reference-data-upload-confirmation', {...i18n['manual-reference-data-upload-confirmation']});
