...
const manualReferenceDataUploadConfirmationController =
  new ManualReferenceDataUploadConfirmationController();
...
describe("Reference data file upload Confirmation Controller", () => {
  it("should render confirmation page", async () => {
    ...
    await manualReferenceDataUploadConfirmationController.get(
      request,
      response
    );
    responseMock.verify();
