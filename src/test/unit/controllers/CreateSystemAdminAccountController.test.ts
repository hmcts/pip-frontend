...
const createSystemAdminAccountController =
  new CreateSystemAdminAccountController();
const validationStub = sinon.stub(
  CreateAccountService.prototype,
  "validateAdminFormFields"
);
  ...
  describe("get requests", () => {
    it("should render create system admin account page with set cookie", async () => {
      ...
      responseMock
        .expects("render")
        .once()
        .withArgs("create-system-admin-account", expectedOptions);
  ...
  describe("post requests", () => {
    ...
    it("should redirect to create system admin account summary page", async () => {
      ...
      responseMock
        .expects("redirect")
        .once()
        .withArgs("create-system-admin-account-summary");
      await createSystemAdminAccountController.post(request, response);
      await responseMock.verify();
    });
  });
