...
const rawData = fs.readFileSync(
  path.resolve(__dirname, "../mocks/magistratesPublicList.json"),
  "utf-8"
);
...
const magistratesPublicListJsonStub = sinon.stub(
  PublicationService.prototype,
  "getIndividualPublicationJson"
);
const magistratesPublicListMetaDataStub = sinon.stub(
  PublicationService.prototype,
...
describe("Magistrates Public List Controller", () => {
  ...
  it("should render the magistrates public list page", async () => {
    ...
    responseMock
      .expects("render")
      .once()
      .withArgs("magistrates-public-list", expectedData);
