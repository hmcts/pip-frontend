...
describe('Sort Helper', () => {
    ...
    describe('Case subscription sorter', () => {
        ...
        it('should sort by case numbers if same case name', () => {
            const cases = [
                { searchType: 'CASE_NUMBER', caseName: 'Case A', caseNumber: '125' },
                { searchType: 'CASE_NUMBER', caseName: 'Case A', caseNumber: '234' },
                { searchType: 'CASE_NUMBER', caseName: 'Case A', caseNumber: '123' },
        ...
        it('should sort by case names first followed by case numbers', () => {
            const cases = [
                { searchType: 'CASE_NUMBER', caseName: 'Case A', caseNumber: '124' },
                { searchType: 'CASE_NUMBER', caseName: 'Case B', caseNumber: '123' },
                { searchType: 'CASE_NUMBER', caseName: 'Case B', caseNumber: '124' },
                { searchType: 'CASE_NUMBER', caseName: 'Case A', caseNumber: '123' },
            ];
