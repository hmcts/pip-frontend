...
downloadFilesStub.withArgs('123', 'PDF', { 'x-requester-id': '1234', 'x-user-id': '1234' }).resolves(expectedPdfData);
downloadFilesStub.withArgs('123', 'EXCEL', { 'x-requester-id': '1234', 'x-user-id': '1234' }).resolves(expectedExcelData);
downloadFilesStub.withArgs('124', 'PDF', { 'x-requester-id': '1234', 'x-user-id': '1234' }).resolves(null);
