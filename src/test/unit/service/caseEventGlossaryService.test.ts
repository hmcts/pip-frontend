...
const stub = sinon.stub(caseEventGlossaryRequests, 'getCourtEventGlossaryList').returns(caseEventGlossaryData);
...
describe('Case Event Glossary Service', () => {
  it(`should return object with ${validStatusDescriptionKeysCount} status description keys`, () => {
    return caseEventGlossaryService.generateCourtEventGlossaryObject().then((data) => {
