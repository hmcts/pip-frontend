...
const responseErrors = {
  ...
  emailError: {
    message:
      "There is a problem - Enter an email address in the correct format, like name@example.com",
    href: "#emailAddress",
    value: "bar",
  },
  employerError: {
    message:
      "There is a problem - Your employers name will be needed to support your application for an account",
    href: "#employer",
    value: "",
  },
  fileUploadError: {
...
const createAzureAccountStub = sinon.stub(
  AccountManagementRequests.prototype,
  "createAzureAccount"
);
const createPIAccStub = sinon.stub(
  AccountManagementRequests.prototype,
  "createPIAccount"
);
const createMediaAccStub = sinon.stub(
  AccountManagementRequests.prototype,
  "createMediaAccount"
);
const bulkCreateAccountsStub = sinon.stub(
  AccountManagementRequests.prototype,
  "bulkCreateMediaAccounts"
);
...
describe("Create Account Service", () => {
  describe("isValidEmail", () => {
    ...
    it("should return true if valid email format is provided", () => {
      expect(createAccountService.isValidEmail("joe.bloggs@hotmail.com")).toBe(
        true
      );
    });
  });
  ...
  describe("validateMediaFullName", () => {
    ...
    it("should return error if name starts with a space", () => {
      expect(
        ...
        "There is a problem - Full name field must not start with a space"
      );
    });
    ...
    it("should return error if name contains double space", () => {
      expect(
        ...
        "There is a problem - Full name field must not contain double spaces"
      );
    });
    ...
    it("should return error if name does not contain at least 1 space", () => {
      expect(
        ...
        "There is a problem - Your full name will be needed to support your application for an account"
      );
    });
  });
  ...
  describe("validateMediaEmailAddress", () => {
    ...
    it("should return error if email starts with a space", () => {
      expect(
        ...
        "There is a problem - Email address field cannot start with a space"
      );
    });
    ...
    it("should return error if email contains double space", () => {
      expect(
        ...
        "There is a problem - Email address field cannot contain double spaces"
      );
    });
  });
  ...
  describe("validateMediaEmployer", () => {
    ...
    it("should return error if employer starts with a space", () => {
      expect(
        ...
        "There is a problem - Employer field cannot start with a space"
      );
    });
    ...
    it("should return error if employer contains double space", () => {
      expect(
        ...
        "There is a problem - Employer field cannot contain double spaces"
      );
    });
  });
  ...
  describe("validateCsvFileContent", () => {
    const file = fs.readFileSync(
      "./manualUpload/tmp/bulkMediaUploadValidationFile.csv",
      "utf-8"
    );
    ...
    it("should return too many accounts error", async () => {
      const file = fs.readFileSync(
        "./manualUpload/tmp/bulkMediaUploadValidationFile_31Accounts.csv",
        "utf-8"
      );
      const error = createAccountService.validateCsvFileContent(
        file,
      ...
      expect(error).toStrictEqual(
        "Too many accounts, please upload a file with 30 accounts or less"
      );
    });

    it("should return no error if maximum record count", async () => {
      const file = fs.readFileSync(
        "./manualUpload/tmp/bulkMediaUploadValidationFile_30Accounts.csv",
        "utf-8"
      );
      const error = createAccountService.validateCsvFileContent(
        file,
  ...
  describe("createAdminAccount", () => {
    it("should return true if valid data is provided", async () => {
      createAzureAccountStub
        .withArgs(validAdminConvertedPayload, validEmail)
        .resolves(azureResponse);
      createPIAccStub.resolves(true);
      const res = await createAccountService.createAdminAccount(
        validAdminPayload,
        validEmail
      );
    ...
    it("should return false if create azure account request fails", async () => {
      createAzureAccountStub
        ...
        .resolves(null);
      expect(
        await createAccountService.createAdminAccount(
          validAdminPayload,
          validEmail
        )
      ).toEqual(false);
  ...
  describe("createMediaAccount", () => {
    it("should return true if valid data is provided", async () => {
      createAzureAccountStub
        .withArgs(validMediaConvertedPayload, validEmail)
        .resolves(azureResponse);
      createPIAccStub.resolves(true);
      const res = await createAccountService.createMediaAccount(
        validMediaPayload,
        validEmail
      );
      expect(res).toEqual(true);
    ...
    it("should return false if create azure account request fails", async () => {
      createAzureAccountStub
        ...
        .resolves(null);
      expect(
        await createAccountService.createMediaAccount(
          validMediaPayload,
          validEmail
        )
      ).toEqual(false);
  ...
  describe("createMediaApplication", () => {
    it("should return true if valid data is provided", async () => {
      ...
      const res = await createAccountService.createMediaApplication(
        validBody,
        validImage
      );
      expect(res).toEqual(true);
  ...
  describe("createSystemAdminAccount", () => {
    const createSystemAccStub = sinon.stub(
      AccountManagementRequests.prototype,
    ...
    it("should response response when created user", async () => {
      ...
      const returnedResponse =
        await createAccountService.createSystemAdminAccount(
          {
  ...
  describe("bulkCreateMediaAccounts", () => {
    it("should return true if valid data is provided", async () => {
      ...
      const res = await createAccountService.bulkCreateMediaAccounts(
        "validFile",
        "fileName",
        "123-1bc"
      );
