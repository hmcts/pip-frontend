...
describe("File handling service", () => {
  describe("validateImage", () => {
    it("should return null if valid image is provided", () => {
      expect(
        fileHandlingService.validateImage(
          validImage,
          englishLanguage,
  ...
  describe("readFile from redis", () => {
    ...
    it("should read a pdf file successfully", async () => {
      ...
      const fileBuffer = await fileHandlingService.readFileFromRedis(
        userId,
        "validationFile.pdf"
      );
    ...
    it("should read a json file successfully", async () => {
      ...
      const file = await fileHandlingService.readFileFromRedis(
        userId,
        "validationJson.json"
      );
  ...
  describe("storeFile in redis", () => {
    ...
    it("should store a pdf file succesfully in redis", async () => {
      ...
      await fileHandlingService.storeFileIntoRedis(
        userId,
        "validationFile.pdf",
        "validation.pdf"
      );
  ...
  describe("removeFile from redis", () => {
    it("should remove a file successfully", async () => {
      ...
      await fileHandlingService.removeFileFromRedis(
        userId,
        "validationFile.pdf"
      );
  ...
  describe("isValidFileType", () => {
    it("should return true for valid image type", () => {
      expect(
        fileHandlingService.isValidFileType("foo.jpg", uploadType.IMAGE)
      ).toBe(true);
    });

    it("should return false for invalid image type", () => {
      expect(
        fileHandlingService.isValidFileType("bar.gif", uploadType.IMAGE)
      ).toBe(false);
    });

    it("should return false for no image type", () => {
      expect(
        fileHandlingService.isValidFileType("buzz", uploadType.IMAGE)
      ).toBe(false);
    });

    it("should return true for valid file type", () => {
      expect(
        fileHandlingService.isValidFileType("foo.pdf", uploadType.FILE)
      ).toBe(true);
    });
    ...
    it("should return false for no file type", () => {
      expect(fileHandlingService.isValidFileType("pop", uploadType.FILE)).toBe(
        false
      );
    });
    ...
    it("should return true for dot separated image file", () => {
      expect(
        fileHandlingService.isValidFileType("f.i.l.e.png", uploadType.FILE)
      );
    });
  });
  ...
  describe("getFileExtension", () => {
    ...
    it("should return file type even if dot-separated filename", () => {
      const fileType = fileHandlingService.getFileExtension(
        "f.i.l.e.n.a.m.e.png"
      );
