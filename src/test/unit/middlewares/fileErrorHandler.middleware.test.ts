...
const fileRequest = {};
const errorRequest = {};
const expectedFileLimitRequest = { file: { size: 2000001, originalname: 'too_large_file.pdf' } };
...
describe('File Error Handler Middleware', () => {
  ...
  it('should set dummy request properties if there is file size error', () => {
    fileErrorHandlerMiddleware({code: 'LIMIT_FILE_SIZE'}, fileRequest, mockResponse as unknown as Response, nextFunction);
