...
describe('Subscriptions add Page initial load', () => {
    ...
    it('should have correct page title', () => {
        ...
        expect(pageTitle).contains('Add email subscription - How do you want to add an email subscription - Court and Tribunal Hearings - GOV.UK', 'Page title does not match header');
    });
