...
describe('Alphabetical Search page', () => {
    ...
    it('should have correct page title', () => {
        ...
        expect(pageTitle).contains('Find a court or tribunal - Select from an A-Z list of courts or tribunals - Court and Tribunal Hearings - GOV.UK', 'Page title does not match');
    });
