...
describe('Home page', () => {
  describe('with English translations', () => {
    ...
    it('should display Welsh service message', () => {
      const message = htmlRes.getElementsByClassName('govuk-body');
      expect(message[4].innerHTML).contains('This service is also available in', 'Could not find language message');
    });
  ...
  describe('with Welsh translations', () => {
    ...
    it('should display Welsh service message', () => {
      const message = htmlRes.getElementsByClassName('govuk-body');
      expect(message[4].innerHTML).contains("Mae'r gwasanaeth hwn hefyd ar gael yn", 'Could not find language message');
    });
  });
});
