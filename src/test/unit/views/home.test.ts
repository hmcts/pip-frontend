...
describe("Home page", () => {
  describe("with English translations", () => {
    ...
    it("should display bullets", () => {
      const bullets = htmlRes
        .getElementsByClassName("govuk-body")[1]
    ...
    it("should display bullets", () => {
      const bullets = htmlRes
        .getElementsByClassName("govuk-body")[7]
        .getElementsByTagName("li");
      expect(bullets[0].innerHTML).contains(
      ...
      expect(
        bullets[0].getElementsByClassName("govuk-link")[0].innerHTML
      ...
      expect(
        bullets[1].getElementsByClassName("govuk-link")[0].innerHTML
...
describe("Cookie banner display", () => {
  ...
  it("should display cookie banner on empty cookie policy cookie", () => {
    const cookieBanner = htmlRes.getElementsByClassName(
  ...
  it("should display accept cookie button", () => {
    const acceptButton = htmlRes.getElementsByClassName(
  ...
  it("should display reject cookie button", () => {
    const rejectButton = htmlRes.getElementsByClassName(
  ...
  it("should show post button click message", () => {
    const acceptedMessage = htmlRes.getElementsByClassName(
      "cookie-banner-accept-message"
    )[0];
    expect(acceptedMessage.innerHTML).contains(
