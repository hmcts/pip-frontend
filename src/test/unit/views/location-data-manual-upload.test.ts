...
const PAGE_URL = '/location-data-manual-upload';
const headingClass = 'govuk-heading-xl';
const insetTextClass = 'govuk-inset-text';

const expectedHeader = 'Location data manual upload';
...
describe('Location Reference Data Manual upload page', () => {
  describe('on GET', () => {
    beforeAll(async () => {
  ...
  describe('on POST', () => {
    ...
    it('should display file too large error', () => {
      const fileError = htmlRes.getElementById('location-data-manual-upload-error');
