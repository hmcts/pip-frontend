...
describe("Admin Management Page", () => {
  ...
  it("should display back button", () => {
    ...
    expect(backButton[5].innerHTML).contains(
      "Back",
  ...
  it("should display the header", () => {
    const header = htmlRes
      .getElementsByClassName(headingClass)[0]
      .getElementsByClassName("govuk-label--l");
  ...
  it("should display continue button", () => {
    ...
    expect(buttons[4].innerHTML).contains(
      expectedButtonText,
