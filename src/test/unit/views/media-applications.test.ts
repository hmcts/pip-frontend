...
sinon
  .stub(MediaApplicationService.prototype, "getPendingMediaApplications")
...
describe("Media applications page", () => {
  ...
  it("should display table with 4 columns", () => {
    ...
    expect(table.getElementsByTagName("th").length).to.equal(
      4,
