    ...
    it('should sort publications by content date followed by list type', () => {
        ...
        expect(innerHTMLs)
            ...
            .to.have.ordered.members([
                ...
                'Single Justice Procedure Public List (Full List) 02 February 2022 - English (Saesneg)',
                'Single Justice Procedure Press List (Full List) 02 February 2022 - English (Saesneg)',
                'Single Justice Procedure Public List (Full List) 28 January 2022 - English (Saesneg)',
            ]);
    });
