...
const expectedHeader = 'Care Standards';
...
describe('Care standards list page', () => {
  beforeAll(async () => {
  ...
  it('should display summary',  () => {
    ...
    expect(summary[0].innerHTML).contains(summaryHeadingText,
  ...
  it('should display court email summary paragraph',  () => {
    ...
    expect(summary[0].innerHTML).contains('court1@moj.gov.uk',
