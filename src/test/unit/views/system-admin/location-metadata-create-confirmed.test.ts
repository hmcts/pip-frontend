...
describe('Location metadata create confirmed page', () => {
    ...
    it('should have correct page title', () => {
        ...
        expect(pageTitle).equals('Location metadata created', 'Page title does not match');
    });

    it('should have correct header', () => {
        const heading = htmlRes.getElementsByClassName('govuk-panel__title');
        expect(heading[0].innerHTML).contains('Location metadata created', 'Header does not match');
    });
