...
const PAGE_URL = '/manage-third-party-subscriptions-created-success';
...
describe('Manage third-party subscriptions created success page', () => {
    beforeAll(async () => {
        await request(app)
            .get(PAGE_URL)
            .then(res => {
    ...
    it('should display success panel', () => {
        ...
        expect(header.innerHTML).contains('Third-party subscriptions created');
    });
