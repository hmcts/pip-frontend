...
describe('Location metadata update confirmed page', () => {
    ...
    it('should have correct page title', () => {
        ...
        expect(pageTitle).equals('Location metadata updated', 'Page title does not match');
    });

    it('should have correct header', () => {
        const heading = htmlRes.getElementsByClassName('govuk-panel__title');
        expect(heading[0].innerHTML).contains('Location metadata updated', 'Header does not match');
    });
