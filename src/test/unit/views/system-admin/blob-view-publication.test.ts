...
describe('Blob explorer publication page', () => {
    describe('for existed location', () => {
        describe.each([publicSensitivity, privateSensitivity, classifiedSensitivity])(
            "with JSON publication of '%s' sensitivity",
            sensitivity => {
                beforeAll(async () => {
                    ...
                    await request(app)
                        .get(
                            '/blob-view-publication?artefactId=' +
        ...
        describe.each([publicSensitivity, privateSensitivity, classifiedSensitivity])(
            "with flat file publication of '%s' sensitivity",
            sensitivity => {
                beforeAll(async () => {
                    app.request['user'] = { userId: '1', roles: 'SYSTEM_ADMIN' };
