...
const cards = [
  {
    title: "Upload",
    description:
      "Upload a file to be published on the external facing Court and tribunal hearings service.",
    link: "manual-upload",
  },
  {
    title: "Remove",
  ...
  },
  {
    ...
    description:
      "Create accounts for: CTSC Super Admin, Local Super Admin, CTSC Admin, Local Admin.",
...
describe("Admin Dashboard page all cards", () => {
  ...
  it("should display 5 links in banner", () => {
    const bannerComponents = htmlRes.getElementsByClassName(
