...
describe("Blob Explorer Page", () => {
  ...
  it("should display the sub heading", () => {
    ...
    expect(subHeading[1].innerHTML).contains(
      "Metadata",
      "Could not find the sub heading"
    );
  });
  ...
  it("should have the artefact id row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[0];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
      summaryListRowValueClass
    )[0];
  ...
  it("should have the language row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[1];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the location id row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[2];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the location name row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[3];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
    ...
    expect(summaryListRow).to.exist;
    expect(rowKey.innerHTML).contains(
      "Location Name",
      "Could not find row key"
    );
    expect(rowValue.innerHTML).contains(
      "Test court 100",
      "Could not find row value"
    );
  });

  it("should have the list type row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[4];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the provenance row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[5];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the publication type row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[6];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the sensitivity row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[7];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the content date row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[8];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
    ...
    expect(rowValue.innerHTML).contains(
      "14th February 2022 at 02:14 pm",
      "Could not find row value"
    );
  });
  ...
  it("should have the display from row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[9];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
  ...
  it("should have the display to row in the summary list", () => {
    const summaryListRow =
      htmlRes.getElementsByClassName(summaryListRowClass)[10];
    const rowKey = summaryListRow.getElementsByClassName(
      summaryListRowKeyClass
    )[0];
    const rowValue = summaryListRow.getElementsByClassName(
    ...
    expect(rowValue.innerHTML).contains(
      "14th February 2052 at 02:14 pm",
      "Could not find row value"
    );
  });
  ...
  it("should have the details dropdown for viewing the json content", () => {
    const detailsSummaryText = htmlRes.getElementsByClassName(
      detailsSummaryTextClass
    )[0];
  ...
  it("should have the correct data in the json container", () => {
    ...
    expect(individualJsonLines[0].innerHTML).contains(
      "{",
