...
describe('Court Name Search Page', () => {
    ...
    it('should have correct page title', () => {
        ...
        expect(pageTitle).contains('Add email subscription - Subscribe by court or tribunal name - Court and Tribunal Hearings - GOV.UK', 'Page title does not match header');
    });
