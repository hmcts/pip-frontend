...
describe('Subscriptions Management Page', () => {
    describe('Verified user with no subscriptions', () => {
        beforeAll(async () => {
    ...
    describe('Verified user with subscriptions', () => {
        beforeAll(async () => {
    ...
    describe('Verified user with case subscriptions only', () => {
        beforeAll(async () => {
        ...
        it('should show noSubsCourt message on location subs tab', async () => {
            await request(app)
    ...
    describe('Verified user with location subscriptions only', () => {
        beforeAll(async () => {
    ...
    describe('Verified user with case URN subscription only', () => {
        beforeAll(async () => {
