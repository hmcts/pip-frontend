...
describe("View Option Page", () => {
  ...
  describe("with error", () => {
    ...
    it("should display an error title", () => {
      const errorTitle = htmlRes.getElementsByClassName(
        "govuk-error-summary__title"
      );
      expect(errorTitle[0].innerHTML).contains(
        "There is a problem",
        "Could not find error title"
      );
    });
