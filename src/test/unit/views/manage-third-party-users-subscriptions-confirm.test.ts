...
describe('Manage third party subscription confirm', () => {
  ...
  it('should display summary body', () => {
    ...
    expect(panelBody[0].innerHTML).contains('Third party subscriptions for the user have been successfully updated',
  ...
  it('should display paragraph part 1', () => {
    ...
    expect(paragraph[0].innerHTML).contains('To manage further subscriptions for third parties, you can go to: ',
