...
const cards = [
  ...
  },
  {
    ...
    description:
      "Get emails about hearings from different courts and tribunals and manage your subscriptions.",
...
describe("Your Account page", () => {
  ...
  describe("With verified param", () => {
    ...
    it("should display the verified banner", () => {
      const banner = htmlRes.getElementsByClassName(
    ...
    it("should display the header inside the verified banner", () => {
      const bannerHeader = htmlRes.getElementsByClassName(
    ...
    it("should display the content inside the verified banner", () => {
      const bannerContent = htmlRes.getElementsByClassName(
