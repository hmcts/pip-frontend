...
describe("Manage User Page", () => {
  ...
  it("should display summary text key - User ID", () => {
    const summaryTextKey = htmlRes.getElementsByClassName(
      summaryTextListKeyClass
    );
    expect(summaryTextKey[0].innerHTML).contains(
      "User ID",
  ...
  it("should display summary text value - User ID", () => {
    const summaryTextValue = htmlRes.getElementsByClassName(
      summaryTextListValueClass
    );
    expect(summaryTextValue[0].innerHTML).contains(
      "1234",
  ...
  it("should display summary text key - Email", () => {
    ...
    expect(summaryTextKey[1].innerHTML).contains(
      "Email",
      "Could not find summary text key"
    );
  });
  ...
  it("should display summary text value - Email", () => {
    ...
    expect(summaryTextValue[1].innerHTML).contains(
      "test@email.com",
      "Could not find summary text value"
    );
  });
  ...
  it("should display summary text key - Role", () => {
    ...
    expect(summaryTextKey[2].innerHTML).contains(
      "Role",
      "Could not find summary text key"
    );
  });
  ...
  it("should display summary text value - Role", () => {
    ...
    expect(summaryTextValue[2].innerHTML).contains(
      "CTSC Super Admin",
      "Could not find summary text value"
    );
  });
  ...
  it("should display summary text change link - Role", () => {
    ...
    expect(link[5].innerHTML).contains(
      "Change",
  ...
  it("should display summary text key - Provenance", () => {
    ...
    expect(summaryTextKey[3].innerHTML).contains(
      "Provenance",
      "Could not find summary text key"
    );
  });
  ...
  it("should display summary text value - Provenance", () => {
    ...
    expect(summaryTextValue[3].innerHTML).contains(
      "B2C",
      "Could not find summary text value"
    );
  });
  ...
  it("should display summary text key - Provenance ID", () => {
    ...
    expect(summaryTextKey[4].innerHTML).contains(
      "Provenance ID",
      "Could not find summary text key"
    );
  });
  ...
  it("should display summary text key - Creation Date", () => {
    ...
    expect(summaryTextKey[5].innerHTML).contains(
      "Creation Date",
      "Could not find summary text key"
    );
  });
  ...
  it("should display summary text value - Creation Date", () => {
    ...
    expect(summaryTextValue[5].innerHTML).contains(
      "05/11/2022 18:45:37",
      "Could not find summary text value"
    );
  });
  ...
  it("should display summary text key - Last Sign In", () => {
    ...
    expect(summaryTextKey[6].innerHTML).contains(
      "Last Sign In",
      "Could not find summary text key"
    );
  });
  ...
  it("should display summary text value - Last Sign In", () => {
    ...
    expect(summaryTextValue[6].innerHTML).contains(
      "07/11/2022 18:45:37",
      "Could not find summary text value"
    );
  });
