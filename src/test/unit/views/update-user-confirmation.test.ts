...
describe('Update User Confirmation Page', () => {
  ...
  it('should display panel heading',  () => {
    ...
    expect(panelHeading[0].innerHTML).contains('User Updated',
  ...
  it('should display panel body',  () => {
    ...
    expect(panelBody[0].innerHTML).contains('This user has been updated to a System Admin. ' +
      'They will need to sign in again for this to take effect', 'Could not find the panel body');
  });
