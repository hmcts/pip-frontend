...
const rawData = fs.readFileSync(
    path.resolve(__dirname, '../../mocks/technologyAndConstructionCourtKbDailyCauseList.json'),
    'utf-8'
);
...
const PAGE_URL = '/technology-and-construction-court-kb-daily-cause-list?artefactId=abc';
...
describe('Technology and Construction Court (KB) Daily Cause List page', () => {
    ...
    it('should display header', () => {
        ...
        expect(header[0].innerHTML).contains('Technology and Construction Court (King’s Bench Division) Daily Cause List');
    });
