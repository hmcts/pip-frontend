...
describe('GRC Weekly Hearing List page', () => {
    ...
    it('should have correct page title', () => {
        ...
        expect(pageTitle).contains(
            'General Regulatory Chamber Weekly Hearing List - Court and Tribunal Hearings – GOV.UK',
    ...
    it('should display join hearing link text', () => {
        const text = htmlRes.getElementsByClassName(bodyText);
        expect(text[9].innerHTML).contains('What to expect when joining a telephone or video hearing');
    });
    ...
    it('should display observe hearing link', () => {
        const text = htmlRes.getElementsByClassName(govukLinkClass);
        expect(text[7].getAttribute('href')).eq('https://www.gov.uk/guidance/observe-a-court-or-tribunal-hearing');
    });
