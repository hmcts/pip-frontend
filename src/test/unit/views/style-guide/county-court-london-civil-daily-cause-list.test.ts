...
describe('County Court at Central London Civil Daily Cause List page in English', () => {
    ...
    it('should display venue', () => {
        ...
        expect(text[6].innerHTML).equals('Thomas More Building');
        expect(text[7].innerHTML).equals('Strand, London');
        expect(text[8].innerHTML).equals('WC2A 2LL');
    });
...
describe('County Court at Central London Civil Daily Cause List page in Welsh', () => {
    ...
    it('should display venue', () => {
        const text = htmlRes.getElementsByClassName(bodyText);
        expect(text[5].innerHTML).equals('Llysoedd Barn Brenhinol');
        expect(text[6].innerHTML).equals('Thomas More Building');
        expect(text[7].innerHTML).equals('Strand, London');
        expect(text[8].innerHTML).equals('WC2A 2LL');
    });
