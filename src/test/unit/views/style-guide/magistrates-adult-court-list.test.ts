...
describe.each([urlDailyList, urlFutureList])("Magistrates Adult Court List page with path '%s'", url => {
    ...
    it('should display empty Date of Birth table cell when field is missing', () => {
        const cell = htmlRes.getElementsByClassName(tableCellClass);
        expect(cell[26].innerHTML).to.empty;
    });
    ...
    it('should display empty Address table cell when field is missing', () => {
        const cell = htmlRes.getElementsByClassName(tableCellClass);
        expect(cell[27].innerHTML).to.empty;
    });
    ...
    it('should display empty Age table cell when field is missing', () => {
        const cell = htmlRes.getElementsByClassName(tableCellClass);
        expect(cell[28].innerHTML).to.empty;
    });
    ...
    it('should display empty Informant table cell when field is missing', () => {
        const cell = htmlRes.getElementsByClassName(tableCellClass);
        expect(cell[29].innerHTML).to.empty;
    });
    ...
    it('should display Offence Summary table header', () => {
        const cell = htmlRes.getElementsByClassName(tableCellClass);
        expect(cell[16].innerHTML).contains('Offence Summary', 'Offence summary header does not match');
    });

    it('should display Offence Summary table cell', () => {
        const cell = htmlRes.getElementsByClassName(tableCellClass);
        expect(cell[17].innerHTML).contains('Offence summary 1', 'Offence summary does not match');
    });
