...
const PAGE_URL = '/court-of-appeal-criminal-daily-cause-list?artefactId=abc';
...
describe('Court of Appeal (Criminal Division) Daily Cause List page', () => {
    ...
    it('should display header', () => {
        ...
        expect(header[0].innerHTML).contains('Court of Appeal (Criminal Division) Daily Cause List');
    });
