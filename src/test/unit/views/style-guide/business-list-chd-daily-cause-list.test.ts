...
const rawData = fs.readFileSync(path.resolve(__dirname, '../../mocks/businessListChdDailyCauseList.json'), 'utf-8');
...
const PAGE_URL = '/business-list-chd-daily-cause-list?artefactId=abc';
...
describe('Business List (Chancery Division) Daily Cause List page', () => {
    ...
    it('should display header', () => {
        ...
        expect(header[0].innerHTML).contains('Business List (Chancery Division) Daily Cause List');
    });
