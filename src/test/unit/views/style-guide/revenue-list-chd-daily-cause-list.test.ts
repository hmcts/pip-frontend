...
const rawData = fs.readFileSync(path.resolve(__dirname, '../../mocks/revenueListChdDailyCauseList.json'), 'utf-8');
...
const PAGE_URL = '/revenue-list-chd-daily-cause-list?artefactId=abc';
