...
describe.each([artefactIdNoSessions, artefactIdNoSession])("Magistrates Public Adult Court List page renders correctly when no sessions or session", artefactId => {
