...
describe('Crown Firm PDDA List page', () => {
    ...
    it('should display list date', () => {
        ...
        expect(body[0].innerHTML).equals('List for 10 September 2025 to 11 September 2025');
    });
    ...
    it('should display court house name', () => {
        const body = htmlRes.getElementsByClassName(bodyClass);
        expect(body[9].innerHTML).contains('TestCourtHouseName', 'Court house name does not match');
    });

    it('should display court house address', () => {
        const body = htmlRes.getElementsByClassName(bodyClass);
        expect(body[10].innerHTML).contains('1 Main Road', 'Court house address line 1 does not match');
        expect(body[11].innerHTML).contains('London', 'Court house address line 2 does not match');
        expect(body[12].innerHTML).contains('A1 1AA', 'Court house address line 3 does not match');
    });

    it('should display court house telephone', () => {
        const body = htmlRes.getElementsByClassName(bodyClass);
        expect(body[13].innerHTML).contains('02071234568', 'Court house telephone does not match');
    });
    ...
    it('should display sitting at time', () => {
        const body = htmlRes.getElementsByClassName(bodyClass);
        expect(body[14].innerHTML).contains('Sitting at 10am', 'Sitting at time does not match');
    });
