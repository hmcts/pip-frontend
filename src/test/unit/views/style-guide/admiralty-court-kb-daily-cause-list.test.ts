...
const rawData = fs.readFileSync(
    path.resolve(__dirname, '../../mocks/admiraltyCourtKbDailyCauseList.json'),
    'utf-8'
);
...
const PAGE_URL = '/admiralty-court-kb-daily-cause-list?artefactId=abc';
...
describe('Admiralty Court (King’s Bench Division) Daily Cause List page', () => {
    ...
    it('should display important information heading 2', () => {
        ...
        expect(text[11].innerHTML).contains(
            'Remote hearings before the Admiralty Registrar'
        );
    });
