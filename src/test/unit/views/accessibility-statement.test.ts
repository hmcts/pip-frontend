...
describe("accessibility-statement", () => {
  ...
  it("should display the page header", () => {
    ...
    expect(header[0].innerHTML).contains(
      "Accessibility statement for the court and tribunal " +
        "hearings service",
  ...
  it("should display the heading in section 2", () => {
    ...
    expect(div.textContent).contains(
      ...
      "Could not find section 2 heading"
    );
  });
  ...
  it("should display the heading in section 3", () => {
    ...
    expect(div.textContent).contains(
      ...
      "Could not find section 3 heading"
    );
  });
  ...
  it("should display the heading in section 5", () => {
    ...
    expect(div.textContent).contains(
      ...
      "Could not find section 5 heading"
    );
  });
  ...
  it("should display the headings in section 8", () => {
    ...
    expect(div.textContent).contains(
      "Compliance status",
      "Could find find section 8 heading"
    );
    expect(div.textContent).contains(
      "Non-accessible content",
      "Could not find section 8 small heading"
    );
  });
