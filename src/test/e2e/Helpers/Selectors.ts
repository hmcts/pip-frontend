module.exports = {
  ...
  // Common selectors
  ContinueButton:
    '//*[@id="main-content"]//*[contains(@class, "govuk-button")]',
  ...
  SecondItemResult:
    "tr.govuk-table__row:nth-child(2) > td:nth-child(2) > a:nth-child(1)",
  ...
  GlossaryTerm:
    "tbody > tr.govuk-table__row > td.govuk-table__cell:nth-child(4) > a.govuk-link",
  ...
  CaseNameSearchResultsHeaderCheckbox:
    "thead > tr.govuk-table__row > th > .govuk-checkboxes__input",
  ...
  ListTableFirstHeaderButton:
    "thead > tr.govuk-table__row > th:nth-child(1) > button",
  ListTableFirstRowFirstCell:
    "tbody > tr.govuk-table__row:nth-child(1) > td:nth-child(1)",
  ListTableLastRowFirstCell:
    "tbody > tr.govuk-table__row:last-child > td:nth-child(1)",
  ...
  locationSelector:
    ".govuk-table__body > tr:nth-child(1) > th:nth-child(1) > a:nth-child(1)",
