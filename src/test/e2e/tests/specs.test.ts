...
let otpLoginTestPage: OtpLoginTestingPage;
...
describe('Finding a court or tribunal listing', () => {
  ...
  describe('Media User Login', () => {
    it('should open the OTP login page when a user clicks "Subscriptions" header', async () => {
      otpLoginTestPage = await homePage.clickSubscriptionsButton();
      expect(await otpLoginTestPage.getPageTitle()).toEqual('Verify your email address');
    });
