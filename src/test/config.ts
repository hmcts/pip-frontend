...
export const config = {
    ...
    SSO_TEST_SUPER_ADMIN_CTSC_USER: process.env.SSO_TEST_SUPER_ADMIN_CTSC_USER,
    SSO_TEST_SUPER_ADMIN_CTSC_PWD: process.env.SSO_TEST_SUPER_ADMIN_CTSC_PWD,
    SSO_TEST_SUPER_ADMIN_LOCAL_USER: process.env.SSO_TEST_SUPER_ADMIN_LOCAL_USER,
