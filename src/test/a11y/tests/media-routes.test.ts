...
describe('Accessibility - Media User Routes', () => {
    ...
    describe('Page with Errors', () => {
        ...
        describe('List Download Disclaimer Page', () => {
            ...
            describe('with invalid input data', () => {
                testAccessibility(url, '', true, { 'disclaimer-agreement': undefined });
            });

            describe('with invalid input data', () => {
                testAccessibility(url, '', true, { 'disclaimer-agreement': true });
            });
        });
        ...
        describe('Pending Subscriptions Page', () => {
            ...
            describe('with invalid input data', () => {
                testAccessibility(url, '', true, { userId: false });
            });
        });
        ...
        describe('Subscription Add Page', () => {
            ...
            describe('with invalid input data', () => {
                testAccessibility(url, '', true, { 'subscription-add': 'true' });
            });

            describe('with invalid input data', () => {
                testAccessibility(url, '', true, { 'subscription-add': 'false' });
            });
        });
    });
});
