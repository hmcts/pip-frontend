...
Scenario(
    'I as a system admin should be able to upload reference data manually',
    async ({I}) => {
        ...
        I.see('Prior to upload you must ensure the file is suitable for location data upload e.g. ' +
