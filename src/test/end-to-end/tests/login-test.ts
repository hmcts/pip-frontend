...
Scenario(
  "I as a system admin should be able to sign-in with the valid credentials",
  async ({ I }) => {
...
Scenario(
  "I as a admin should be able to sign-in with the valid credentials",
  async ({ I }) => {
    I.loginAsAdmin();
...
Scenario(
  "I as a media user should be able to sign-in with the valid credentials",
  async ({ I }) => {
    I.loginAsMediaUser();
    I.see("Your account");
    I.logout();
