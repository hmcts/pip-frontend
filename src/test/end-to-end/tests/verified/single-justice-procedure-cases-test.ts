...
Scenario(
    'I as a verified user should be able to view all the single procedure cases',
    async ({I}) => {
        ...
        I.see('Cases ready to be decided by a magistrate without a hearing. Includes TV licensing, minor traffic offences such as speeding and more.');
