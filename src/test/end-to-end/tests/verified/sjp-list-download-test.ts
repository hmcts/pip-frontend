...
Scenario(
    'I as a verified user should be able to download sjp public list',
    async ({I}) => {
        ...
        I.see('As a verified user of the court and tribunal hearings service you are authorised to download this file containing personal protected data.');
        I.see('It is your responsibility to ensure you comply with any GDPR and/or reporting restrictions regarding the content of this file.');
...
Scenario(
    'I as a verified user should be able to download sjp press list',
    async ({I}) => {
