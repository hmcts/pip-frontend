...
Scenario('I as an unverified user should be able to make end-to-end journey', async ({ I }) => {
    ...
    I.see('Hearings in Civil and Family Courts in the South East, South West (excluding Bristol), Wales and some courts in the Midlands (Birmingham), North East and North West regions');
