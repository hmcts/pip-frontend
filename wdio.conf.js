const drivers = {
    ...
    chrome: { fullUrl: 'https://edgedl.me.gvt1.com/edgedl/chrome/chrome-for-testing/115.0.5790.102/linux64/chrome-linux64.zip' },
...
exports.config = {
    ...
    // - @wdio/cli, @wdio/config.ts, @wdio/utils
    // Level of logging verbosity: trace | debug | info | warn | error | silent
    // logLevels: {
    //     webdriver: 'info',
     ...
     */
    // beforeSession: function (config.ts, capabilities, specs) {
    // },
    /**
